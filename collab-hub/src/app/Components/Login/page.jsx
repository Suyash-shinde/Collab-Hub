      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
          <div className="w-3/5 p-5">
              ...
              <div className="flex flex-col items-center ">
                <div className="bg-gray-100 rounded-lg  w-64 p-2 flex items-center m-3">
                  <input
                    ...
                    name="email"
                    placeholder="Email"
                    className=" m-2 flex-1 bg-gray-100 outline-none text-sm"
                  />
                </div>
            ...
            <Link
              href="#"
              className="border-2 m-6 border-green-500 text-green-500  rounded-full px-12 py-2 inline-block font-semibold hover:bg-green-500 hover:text-white"
            >
              Sign in
            </Link>
          </div>
